<template>
  <div class="hello">
    ...
    <div class="listSearchC">
      ...
      <el-row>
        <el-col :span="12">
          <router-link to="/passManage/SceneAdd" class="el-button">新增</router-link>
      ...
      <el-table
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            <router-link :to="'/passManage/SceneAdd?id='+scope.row.id" class="el-button el-button--mini redbtn">编辑</router-link>
